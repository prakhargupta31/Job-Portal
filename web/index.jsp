<%-- 
    Document   : index
    Created on : 19 Nov, 2023, 10:56:15 PM
    ...
    <body>
        <div class="container-fluid">
			...
			<div class="row" style="border: 2px solid black;">
                            <img src="Images/new1.png " style="width: 100%;background-size: cover"/>
			</div>
			...
			<div class="row">
				<div class="col-md-3">
                                    <img src="Images/searchicon.png"  height="100%" width="100%" style="background-size: cover"/>
				</div>
