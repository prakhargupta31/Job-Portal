<%-- 
    Document   : Profile
    Created on : 20 Nov, 2023, 6:55:17 PM
    Author     : PRAKHAR GUPTA
--%>

<%@page import="com.prakhar.backend.PathDetails"%>
                ...
                <div class="row" style="border: 1px solid gray; box-shadow: 0px 0px 2px gray; border-radius: 3px">
                    ...
                    <div class="row"  style="border: 1px solid gray; box-shadow: 0px 0px 2px gray; border-radius: 3px">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <a href="upload-resume.jsp"> <span class="glyphicon glyphicon-pencil"></span> Upload Resume </a>
                            <jsp:scriptlet>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="resume-builder-details.jsp"> <span class="glyphicon glyphicon-plus"></span> Resume Builder </a>
                                <jsp:scriptlet>
